...
| `一句话视频创作 <prompt>` | Natural-language video creation. Parses total duration/shot duration/candidates and runs the storyboard candidate-selection flow automatically. | `python scripts/run_video_skill.py --env-file <env> --user-input "<prompt>" --out-dir <out>` |
